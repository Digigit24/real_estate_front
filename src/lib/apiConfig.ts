...
export const API_CONFIG = {
  ...
  BROKER_PORTAL: {
    ...
    // Broker Portal Specific Lead Endpoints (Under /brokers/portal/ prefix)
    LEADS: '/brokers/portal/my-leads/',
    LEAD_DETAIL: '/brokers/portal/my-leads/:id/',
    LEAD_ACTIVITY: '/brokers/portal/my-leads/:id/add-activity/',
    LEAD_MOVE_STATUS: '/brokers/portal/my-leads/:id/move-to-status/',
    LEAD_BULK_DELETE: '/brokers/portal/my-leads/bulk-delete/',
    LEAD_BULK_STATUS: '/brokers/portal/my-leads/bulk-update-status/',
    LEAD_BULK_ASSIGN: '/brokers/portal/my-leads/bulk-assign/',
    LEAD_IMPORT_TEMPLATE: '/brokers/portal/my-leads/import-template/',
    LEAD_IMPORT_BULK: '/brokers/portal/my-leads/import-bulk/',
    LEAD_EXPORT: '/brokers/portal/my-leads/export/',

    // Statuses & Activities
    STATUSES: '/brokers/portal/statuses/',
    STATUS_DETAIL: '/brokers/portal/statuses/:id/',
    STATUS_INIT: '/brokers/portal/statuses/initialize-defaults/',

    // Activities
    ACTIVITIES: '/brokers/portal/activities/',
    ACTIVITY_DETAIL: '/brokers/portal/activities/:id/',
    ...
    // Inventory
    PROJECTS: '/brokers/portal/inventory/projects/',
    PROJECT_DETAIL: '/brokers/portal/inventory/projects/:id/',
    PROJECT_INVENTORY_SUMMARY: '/brokers/portal/inventory/projects/:id/inventory-summary/',
    TOWERS: '/brokers/portal/inventory/towers/',
    TOWER_DETAIL: '/brokers/portal/inventory/towers/:id/',
    TOWER_UNIT_GRID: '/brokers/portal/inventory/towers/:id/unit-grid/',
    UNITS: '/brokers/portal/inventory/units/',
    UNIT_DETAIL: '/brokers/portal/inventory/units/:id/',
    UNIT_RESERVE: '/brokers/portal/inventory/units/:id/reserve/',
    UNIT_RELEASE: '/brokers/portal/inventory/units/:id/release/',
    UNIT_UPDATE_STATUS: '/brokers/portal/inventory/units/:id/update-status/',
    UNIT_PRICE_CALCULATOR: '/brokers/portal/inventory/units/price-calculator/',
    UNIT_SUGGEST: '/brokers/portal/inventory/units/suggest/',

    // Bookings
    BOOKINGS: '/brokers/portal/bookings/',
    BOOKING_DETAIL: '/brokers/portal/bookings/:id/',
    BOOKING_MILESTONES: '/brokers/portal/bookings/:id/milestones/',
    BOOKING_MILESTONE_MARK_PAID: '/brokers/portal/bookings/:id/milestones/:mid/mark-paid/',
    BOOKING_DEMAND_LETTER: '/brokers/portal/bookings/:id/demand-letter-data/',
    BOOKING_RECEIPT: '/brokers/portal/bookings/:id/milestones/:mid/receipt-data/',
    BOOKING_SUMMARY: '/brokers/portal/bookings/summary/',
    BOOKING_UPCOMING_PAYMENTS: '/brokers/portal/bookings/upcoming-payments/',
  },
